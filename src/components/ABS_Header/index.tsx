      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          ...
          <div className="logo-container">
            ...
            >
              <path
                className="h-path fill-foreground opacity-100"
            ...
            <svg ref={fullTextRef} id="fullText" viewBox="0 0 1474 201" xmlns="http://www.w3.org/2000/svg" className="">
              ...
              {/* Rest of the letters */}
              <path
                className="text-path fill-foreground opacity-0"
              ...
              />
              <path className="text-path fill-foreground opacity-0" d="M665.58 195.68H625.73V0H665.58V195.68Z" />
              <path
                className="text-path fill-foreground opacity-0"
              ...
              />
              <path className="text-path fill-foreground opacity-0" d="M1473.62 152.09H1430.04V195.67H1473.62V152.09Z" />
            </svg>
          </div>

          {/* Theme Toggle and Price */}
          <div className="flex items-center gap-4">
            <ThemeToggle />
            <div className="text-right min-w-0 flex-shrink-0">
              <p className="text-xs text-muted-foreground whitespace-nowrap">{totalLabel}</p>
