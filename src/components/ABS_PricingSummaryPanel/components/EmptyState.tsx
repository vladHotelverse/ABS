    ...
    return (
      <div className="text-center space-y-4">
        ...
        <div className="space-y-2">
          <h3 className="text-base font-medium text-foreground">{customizeStayTitle}</h3>
          <p className="text-sm text-muted-foreground max-w-sm mx-auto">{emptyCartMessage}</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      <div className="text-center">
        <h3 className="text-base font-medium text-foreground mb-2">{customizeStayTitle}</h3>
        <p className="text-sm text-muted-foreground">{chooseOptionsSubtitle}</p>
      </div>
