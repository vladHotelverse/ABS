...
function SegmentBadge({ className, color, segmentDiscount, showIcon = false, ...props }: SegmentBadgeProps) {
  const badgeColor =
    color || (segmentTypeColors[segmentDiscount.segmentType] as 'blue' | 'green' | 'purple' | 'orange' | 'red' | 'gold')
